...
public class SBox {
    ...
    /**
     * Below is an implementation of a Rijndael substitution box. Instead of conventionally
    ...
    /**
     * This substitution box for Rijndael is a direct inverse of the substitution box used
     * for the encryption process, such that InvSub(Sub(x)) == x where x is a byte. Therefore,
     * the box below is used for decryption in the Rijndael cipher.
     * */
    public static final byte[] INVERSE_SBOX = {
    ...
    public static byte getSub(byte b, boolean inverse){
        return inverse ? INVERSE_SBOX[b >= 0 ? b : b + 256]
                       : S_BOX[b >= 0 ? b : b + 256];
    }

    public static byte getInvSub(byte b){
        return INVERSE_SBOX[b >= 0 ? b : b + 256];
    }
}
